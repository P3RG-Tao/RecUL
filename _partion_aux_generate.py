...
load_path = './Weights/MF//MF_lr-0.0001-embed_size-64-batch_size-2048-data_type-full-dataset-mooper-attack-0.01-seed-1024-init_std-0.0001-m.pth'
data_path = './Data/Process/'
dataset = 'Amazon'  # 'Amazon' BookCrossing
attack = '0.01'  # '0.01'
embed_size = 64
