...
import pickle
import torch
from sklearn.metrics import roc_auc_score, ndcg_score, top_k_accuracy_score
...
class model_hyparameters(object):
    def __init__(self):
        ...
        self.biased = False
        self.init_std = 1e-3
        self.part_type = 1  # 0: whole data, 1: interaction_based, 2: user_based, 3: random  4:HDRF  5:BCESP 6:CESP
...
def main(config_args):
    ...
    config = dict()
    data_generator = Data_for_RecEraser_MF(args.data_path + args.dataset + '/' + args.attack, args.batch_size, args.part_type, args.part_num, args.part_T)
    ...
    local_sum = sum(total_time) - total_time[-1]
...
if __name__ == '__main__':
    ...
    config = {
        ...
        'attack': '0.02',
        'seed': 1024,
        'part_type': 6, # 0: whole data, 1: interaction_based, 2: user_based, 3: random  4:HDRF  5:BCESP 6:CESP
    }
    main(config)
