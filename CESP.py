...
class GraphPartitioner4:
    ...
    def getPartitionNumberOfEdge(self, src, dest, rat):
        ...
        self.addEdge(src, dest, rat, partitionId)
        return partitionId
    ...
    def run_partitioning(self, input_filename, output_filename):
        data_reorganizer = DataReorganizer('.../RecUL/Data/Process/Amazon/0.02/train.csv',
                                           'Amazon_reorganized0.02.txt')
